...
#
#
# based on plotDensities ()
#
#
#

plotDensities.with.main<- local(function (object, log = TRUE, arrays = NULL, singlechannels = NULL,
    groups = NULL, col = NULL,main= "RG densities")
{
    ...
    matplot(dens.x$X, dens.x$Y, xlab = "Intensity", ylab = "Density",
        main = main, type = "l", col = cols, lwd = 2,
        lty = 1)
})